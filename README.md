...
Custom validation with arguments doesn't work on nested validation. See [`validator_derive_tests/custom.rs`](validator_derive_tests/custom.rs) and [`validator_derive_tests/custom_args.rs`](validator_derive_tests/custom_args.rs) for more examples.
